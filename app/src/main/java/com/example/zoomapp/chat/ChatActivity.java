package com.example.zoomapp.chat;
...
import com.example.zoomapp.call.utils.ToastUtils;
import com.example.zoomapp.chat.imagepick.ImagePickHelper;
import com.example.zoomapp.chat.imagepick.OnImagePickedListener;
import com.example.zoomapp.chat.listeners.AttachClickListener;
import com.example.zoomapp.chat.listeners.MessageLongClickListener;
import com.example.zoomapp.chat.managers.DialogsManager;
import com.example.zoomapp.chat.qb.PaginationHistoryListener;
import com.example.zoomapp.chat.qb.QbChatDialogMessageListenerImp;
import com.example.zoomapp.chat.qb.QbDialogHolder;
import com.example.zoomapp.chat.qb.QbDialogUtils;
import com.example.zoomapp.chat.qb.QbUsersHolder;
import com.example.zoomapp.chat.qb.VerboseQbChatConnectionListener;
import com.example.zoomapp.chat.views.AttachmentPreviewAdapterView;
...
public class ChatActivity extends BaseActivity implements OnImagePickedListener,
    ...
    private com.example.zoomapp.chat.ChatAdapter chatAdapter;
    ...
    private void showFilePopup(int itemViewType, final QBAttachment attachment, View view) {
        ...
        if (itemViewType == com.example.zoomapp.chat.ChatAdapter.TYPE_TEXT_RIGHT || itemViewType == com.example.zoomapp.chat.ChatAdapter.TYPE_ATTACH_RIGHT) {
            popupMenu.setGravity(Gravity.RIGHT);
        } else if (itemViewType == com.example.zoomapp.chat.ChatAdapter.TYPE_TEXT_LEFT || itemViewType == com.example.zoomapp.chat.ChatAdapter.TYPE_ATTACH_LEFT) {
            popupMenu.setGravity(Gravity.LEFT);
        }
