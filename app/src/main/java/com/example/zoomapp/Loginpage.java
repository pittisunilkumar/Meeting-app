...
public class Loginpage extends BaseActivity implements View.OnClickListener {
    ...
    private AppCompatButton btnsigngoo;
    private AppCompatButton btnsignfb;
    ...
    private void initViews(){
        ...
        tcancel = findViewById(R.id.textViewCancel);
        ttittle = findViewById(R.id.textViewTitle);
        btnsignin = findViewById(R.id.btnSignIn);
        btnsigngoo = findViewById(R.id.btnLoginWithGoogle);
        btnsignfb = findViewById(R.id.btnLoginWithFacebook);
    ...
    private void clickListener() {
        ...
        btnsigngoo.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnSignIn:
                ...
                else if (!isValidEmail(eemail.getText().toString())) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // If sign in fails, display a message to the user.
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            Toast.makeText(Loginpage.this, "Authentication Error", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void updateUserOnServer(QBUser user) {
        ...
        QBUsers.updateUser(user).performAsync(new QBEntityCallback<QBUser>() {
            ...
            public void onSuccess(QBUser qbUser, Bundle bundle) {
                hideProgressDialog();
//                HomeActivity.start(Loginpage.this);
